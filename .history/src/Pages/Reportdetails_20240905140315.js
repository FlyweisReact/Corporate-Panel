...
const Reportdetails = () => {
  ...
  const [overspeedingOption] = useState({
    chart: {
      width: "100px", // Specify width in pixels
      height: "100px", // Specify height in pixels
      type: "pie",
    },
    labels: ["Overspeeding"],
    dataLabels: {
  ...
  return (
    <div className="p-4">
      ...
      <div className="report-chart-container">
        <div className="my-chart pie-chart">
        ...
        <div className="my-chart pie-chart chart-container">
  <ReactApexChart
