...
const Vehicles = () => {
  ...
  const tbody = data?.data?.docs?.map((i) => [
    ...
    <div className="text-left">
      <p className="bold">78616</p>
      <p>3AKJHHDR2KSHU7041</p>
    </div>,
    "Truck",
    ...
    "----",
    <div className="danger-badge">9</div>,
    <div class="text-textcolours-highemphasis text-sm font-medium py-4 px-2 pr-4" id="">Mohammad Ehsan, Talha Shafiq, Adama Quattara, Ahmed Shafique, Theron Don</div>
    "",
    "",
    "",
    "",
