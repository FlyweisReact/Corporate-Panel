  ...
  return (
    <>
      <div className="log-book mb-3">
        ...
        <div className="bg-[#F4F6FA] drop-content ">
          <div className="grid grid-cols-5 gap-4  p-5  bg-white">
            ...
            <div className="text-[#8E8F8F]">
              <p>Signature</p>
              <div className="flex items-center justify-center border border-dashed border-[#939eb9] gap-2 text-[#F56C89] p-4 bg-[#F3F5FB] mt-2 rounded-xl font-">
      ...
      >
        ...
        <div
          className="mt-4 border border-1 border-[#D8D8D8]"
          style={{
            boxShadow: "0px 12px 12px 0px #EDEDED40",
            borderRadius: "12px",
          }}
        ...
        <div className="flex justify-center gap-4 mt-8">
          <button
            className="text-[#F56C89] w-[250px] py-2 rounded-sm"
            style={{ border: "1px solid #F56C89" }}
          >
            Cancel
          </button>
          <button
            className="text-white w-[250px] py-2 bg-[#34B7C1] rounded-sm"
            style={{ border: "1px solid #34B7C1" }}
          >
            Update
          </button>
