...
const Drivers = () => {
  ...
  const activeTableBody = data?.data?.docs?.map((i) => [
    ...
    <div className="flex gap-2 items-center justify-center">
      <img
        src="https://img.freepik.com/free-vector/businessman-character-avatar-isolated_24877-60111.jpg?t=st=1723635839~exp=1723639439~hmac=38f26c7f6fb7c6fd4cb89a451c8bc3cf2ec6d3a0194491b1cfe67be364a184a8&w=826"
        alt=""
        className="user-img"
      />
      Surrinder Singh
