...
const IftareportsDetails = () => {
  ...
  const thead = ["Truck", "Distance(miles)", "Gallons", "Amount"];
    ...
    <div className="p-5 bg-[#F5F8F9] h-screen">
      ...
      <div className="flex bg-white rounded gap-4 mt-5 ifta-trips-detail">
        ...
        <div className="remaining-list">
          ...
          <div>
            <div className="h-[85px] w-[820px] rounded-lg bg-[#FEF3C7] font-semibold border border-[#CA8A04] flex justify-center items-center gap-2 alert">
