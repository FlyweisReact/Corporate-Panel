...
import { CreateDriver, EditDriver, UnAssignDriver } from "../Components/Modal/Modal";
...
const Drivers = () => {
  ...
  const activeTableBody = data?.data?.docs?.map((i) => [
    ...
    <div className="flex gap-1 items-center justify-center">
      78617
      <i className="fa-solid fa-pen" onClick={() => setUna} ></i>
    </div>,
    "---",
    i?.license ? i?.license : "---",
    "---",
  ...
  return (
    <>
      ...
      <UnAssignDriver show={unassignModal} handleClose={() => setUnassignModal(false)} />
