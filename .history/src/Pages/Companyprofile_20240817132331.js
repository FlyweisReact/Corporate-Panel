...
import { EditCompanyAddress, EditHomeTerminal } from "../Components/Modal/Modal";
...
const Companyprofile = () => {
  ...
  return (
    <div className="p-5">
    <EditCompanyAddress show={show} handleClose={() => setShow(false)} />
      ...
      <div className="companyDetails">
        ...
        <div className="content">
          <div className="flex flex-col gap-5">
            <div
              className="h-[100px] w-full  flex justify-between items-center pl-10 pr-10  rounded-xl"
