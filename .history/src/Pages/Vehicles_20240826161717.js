...
const Vehicles = () => {
  ...
  const DeactivatedTBody = deactiveData?.data?.docs?.map((i) => [
    ...
    <p className="text-blue-600 underline" onClick={() => activeStatus(i._id)}>
      Activate
    </p>,
  ]);
  ...
  const removeHandler = (id) => {
    deleteApi(endPoints.vehicles.removeTruck(id), {
      setLoading,
