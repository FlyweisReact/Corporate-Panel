...
const Drivers = () => {
  ...
  const fetchDeleteDrivers = () => {
    getApi(endPoints.driver.allDeletedDriver, {
  ...
  const deactivateDriver = () => {
    ...
    putApi(endPoints.drivers.updateDriverStatus, payload, {
      successMsg: "Updated",
      additionalFunctions: [fetchHandler, fetchDeleteDrivers, () => setIds([])],
    });
  };

  // --- fetch in-active drivers
  ...
  console.log("inactiveDrivers", inactiveDrivers);
  return (
    <>
      <CreateDriver
        show={open}
