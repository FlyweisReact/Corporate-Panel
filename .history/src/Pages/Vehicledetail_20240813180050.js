    ...
    <>
      ...
      <div className="p-5">
        ...
        <div className="tabs-list">
          <ul>
            <li className={selectedTab === 'Overview' ? 'active' :""} onClick={() => setselectedTab("Overview")}>Overview</li>
            <li  onClick={() => setselectedTab("Active DTC Codes")}>Active DTC Codes ({activeDTC?.data?.totalDocs})</li>
          </ul>
        </div>
