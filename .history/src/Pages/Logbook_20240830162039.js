    ...
    <section className="p-5">
      ...
      <div className="flex flex-col md:flex-row gap-4 justify-between mt-5">
        ...
        >
          ...
          {
            activeDrivers?.data?.totalDocs ||  inactiveDriver?.data?.totalDocs ||  deletedDriver?.data?.totalDocs
          }  
        <PieChart
          title={"Drivers"}
          link={"/Drivers"}
          ...
          {...console.log("PieChart Data:", {
            active: activeDrivers?.data?.totalDocs,
            inactive: inactiveDriver?.data?.totalDocs,
            deleted: deletedDriver?.data?.totalDocs,
          })}
        />
