...
const Tabs = ({ tab, setTab, option, isBtn = false, onClickEvent , btnLabel ="Add Tru" }) => {
  return (
    <div className="tabs-list">
      ...
      {isBtn && (
        <button className="add-btn" onClick={() => onClickEvent()}>
          <IoMdAdd />
          Add Truck
        </button>
      )}
...
export { Loader, Pagination, InputComponent, ButtonComponent, Tabs };
