          ...
          <div className="pl-5 pr-5">
            ...
            <div className="flex-inputs">
              <div>
                ...
                <select className="text-select">
                  <option></option>
                  <option>Semi-Trailer Truck</option>
                  <option>18-Wheeler Truck</option>
                  <option>Flatbed</option>
                  <option>Box Truck</option>
                  <option>Van</option>
                  <option>Refrigerator Truck</option>
                  <option>Pickup Truck</option>
                  <option>Power Unit only</option>
                </select>
              </div>
              <div>
                <label className="text-[#8E8F8F]">
            ...
            <div className="flex-inputs">
              ...
              <div className="flex-inputs" style={{ marginTop: 0 }}>
                <div>
                  <label className="text-[#8E8F8F]">Hours Available/Day</label>
                  <br />
                  <select className="text-select">
              ...
              <>
                <div className="flex-inputs">
                  ...
                  <div>
                    ...
                    <br />
                    <select className="text-select">
                      <option>USA 70 hours / 8 days (Interstate)</option>
                      <option>Alaska 70 hours / 8 days (Interstate)</option>
                    </select>
                  </div>
                </div>
                ...
                <div className="flex-inputs">
                  ...
                  <div>
                    ...
                    <br />
                    <select className="text-select">
                      <option>24 Hour Restart</option>
                      <option>34 Hour Restart</option>
                ...
                <div className="flex-inputs">
                  <div>
                    ...
                    <br />
                    <select className="text-select">
                      <option>30min break required</option>
...
const UnAssignDriver = ({ show, handleClose }) => {
  return (
    <Modal
      centered
          ...
          <div className="pl-5 pr-5">
            <div className="gap-5 justify-center mt-5 flex flex-col">
              ...
              <div>
                <label className="text-[#8E8F8F]">Current Vehicle</label>
                <br />
                <InputComponent className="text-input" required value={78617} />
              </div>
              <div>
          ...
          <div className="pl-5 pr-5">
            ...
            <div className="trip-box-container">
              ...
              <div>
                ...
                <br />
                <InputComponent className="text-input" placeholder="Enter Comment..." required />
              </div>
            </div>
            ...
            <div className="flex justify-between mt-5 gap-5 m-5">
              <ButtonComponent
                label={"Cancel"}
                className={
                  "bg-[#fff] w-[50%] h-[45px] text-[#eb5757] flex justify-center items-center gap-2 border border-color-[#eb5757"
                }
