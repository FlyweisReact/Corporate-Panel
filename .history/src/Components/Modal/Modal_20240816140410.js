        ...
        <form onSubmit={submitHandler}>
          <div className="pl-5 pr-5">
            <div className="flex-inputs">
              ...
              <div>
                <label className="text-[#8E8F8F]">Last Name <span className="text-[#a63019]">*</span></label>
                <br />
                <InputComponent
                  placeholder=""
                  className="text-input"
            ...
            <div className="flex-inputs">
              <div>
                <label className="text-[#8E8F8F]">Email address <span className="text-[#a63019]">*</span></label>
                <br />
                <InputComponent
                  placeholder=""
                  className="text-input"
