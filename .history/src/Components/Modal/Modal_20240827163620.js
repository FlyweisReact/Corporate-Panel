...
const CreateDriver = ({ handleClose, show, fetchApi }) => {
  ...
  const submitHandler = (e) => {
    ...
    postApi(endPoints.drivers.createDriver, payload, {
      additionalFunctions: [(res) => setResponse(res)],
      setLoading,
    });
  };
  ...
  const id = "66cdb0228fe81aa05b524bef";
  ...
  const editCycleInfo = (e) => {
    ...
    putApi(endPoints.drivers.updateDriver(id), payload, {
      setLoading,
    });
  };
            ...
            <form onSubmit={editCycleInfo}>
              ...
              <div className="flex-inputs">
                <div>
                  ...
                  <br />
                  <select className="text-select" onChange={(e) => setCargoType(e.target.value)}
                  required
                  >
                  <option value=''></option>
                ...
                <div>
                  ...
                  <br />
                  <select className="text-select" onChange={(e) => setRestart(e.target.value)} required >
                    <option value=''></option>
              ...
              <div className="flex-inputs">
                <div>
                  ...
                  <br />
                  <select className="text-select"  onChange={(e) => setBreakCycle(e.target.value)} required  >
                    <option value=''></option>
                    <option value='30min break required'>30min break required</option>
...
const ViewProfile = ({ show, handleClose }) => {
