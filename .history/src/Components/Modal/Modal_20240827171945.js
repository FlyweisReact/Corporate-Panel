...
const EditDriver = ({ handleClose, show, fetchApi, data }) => {
  ...
  const [ restrictPersonalConveyance ,setRestrictPersonalConveyance ] = useState("")
        ...
        <div className="pl-5 pr-5">
          ...
          {step === 3 && (
            <form onSubmit={updateSetting}>
                <div className="flex-inputs">
                  <div className="w-100">
                    <input type="checkbox" className="text-input mr-4" onChange={() => setBlockDriverEdits(!blockDriverEdits)} />
