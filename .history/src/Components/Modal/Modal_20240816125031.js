      ...
      <div className="reset-password-modal">
        ...
        <form onSubmit={submitHandler}>
          <div className="pl-5 pr-5">
            ...
            <div className="upload-img-svg">
            <svg class="w-24 h-24 rounded-full overflow-hidden cursor-pointer"><use href="/pictures/Icons/appSprite.svg#defaultProfilePicture"></use></svg>
            </div>
