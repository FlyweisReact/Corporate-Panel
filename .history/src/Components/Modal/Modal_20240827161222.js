              ...
              <>
                ...
                <div className="flex-inputs">
                  <div>
                    ...
                    <select className="text-select" onChange={(e) => setCountry(e.target.value)} >
                      <option value='' ></option>
                  ...
                  <div>
                    ...
                    <select className="text-select" onChange={(e) => setState(e.target.value)}>
                ...
                <div className="flex-inputs">
                  <div>
                    ...
                    <InputComponent
                      ...
                      required={true}
                      type="date"
                      onChangeEvent={(e) => setLicenseExpire(e.)}
                    />
                  </div>
                  <div>
                    <label className="text-[#8E8F8F]">
