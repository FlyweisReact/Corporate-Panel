      ...
      <div className="reset-password-modal">
        ...
        <form onSubmit={submitHandler}>
          <div className="pl-5 pr-5">
            ...
            <div className="flex-inputs">
              <div>
                <label className="text-[#8E8F8F]">Email Address
            ...
            <div className="flex-inputs">
              <div>
                <label className="text-[#8E8F8F]">Country <span className="text-[#a63019]">*</span></label>
                <select className="text-select">
                <option></option>
              ...
              <div>
                <label className="text-[#8E8F8F]">License State <span className="text-[#a63019]">*</span></label>
                <select className="text-select">
            ...
            <div className="flex-inputs">
              <div>
                <label className="text-[#8E8F8F]">License Expiration</label>
              </div>
            </div>
