            ...
            <form onSubmit={editCycleInfo}>
              <div className="flex-inputs">
                ...
                <div>
                  ...
                  <br />
                  <select className="text-select" onChange={(e) => setCycle(e.target.value)}
                  required>
                    <option value=''></option>
                    <option value='USA 70 hours / 8 days (Interstate)'>USA 70 hours / 8 days (Interstate)</option>
                    <option value='Alaska 70 hours / 8 days (Interstate)'>Alaska 70 hours / 8 days (Interstate)</option>
                  </select>
                </div>
              </div>
