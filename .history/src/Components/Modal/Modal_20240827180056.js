...
useEffect(() => {
 if(show){
  ...
  setRestrictYardMove(data?.restrictPersonalConveyance)
 }
},[show])
              ...
              <div className="flex-inputs">
                <div>
                  <input
                    type="checkbox"
                    className="text-input mr-4"
                    onChange={() => setExtend(!extend14hoursWithSplitSleeperRule)}
                  />
                  <label className="text-[#8E8F8F]">
              ...
              <div className="flex-inputs">
                <div>
                  <input
                    type="checkbox"
                    className="text-input mr-4"
                    onChange={() => setRestrictPersonalConveyance(!restrictPersonalConveyance)}
                  />
                  <label className="text-[#8E8F8F]">
